...
\begin{itemize}[leftmargin=0.5cm, nosep]
    \item Automated infrastructure provisioning using \textbf{Terraform} in \textbf{Microsoft Azure}.
    ...
    \item Worked with \textbf{Python} and \textbf{TypeScript}
\end{itemize}
...
\begin{itemize}[leftmargin=0.5cm, itemsep=6pt, label=\textbullet]
    ...
    \item \textbf{Frameworks \& Libraries:} .NET, React, Tailwind, gRPC, Flask, TensorFlow, Spring
    \item \textbf{Cloud Platforms \& IoT:} AWS (S3, Lambda, EC2, RDS, SQS, Amplify, ECS, ECR), Azure (Functions, Service Bus, IoT Hub), RabbitMQ
