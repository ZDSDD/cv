...
\begin{itemize}[leftmargin=0.5cm, itemsep=4pt]
    ...
    \item \textbf{IDEs \& Tools:} Visual Studio, Visual Studio Code, JetBrains Rider
    \item \textbf{Database \& Messaging:} PostgreSQL, Redis, RabbitMQ
    \item \textbf{API \& Authentication:} REST, JWT, OAuth2
    \item \textbf{Frontend Development:} React, TypeScript, JavaScript, HTML/CSS, Tailwind
    \item \textbf{DevOps \& Tools:} Docker, Kubernetes, Git, GitHub Actions, Bash, WSL
    \item \textbf{Cloud:} AWS
    \item \textbf{Software Practices:} Test-Driven Development, SOLID Principles, Design Patterns, Clean Code
...
\textit{.NET, Azure} | \href{https://github.com/ZDSDD/IoT_OpcAgent}{GitHub}
\begin{itemize}[leftmargin=0.5cm, nosep]
